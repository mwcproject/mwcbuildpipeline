...
set NAME=mwc-qt-wallet-2.0.!NUMBER_GLOBAL!.beta.%1-win64-setup.exe
set NAME_UPLOAD=mwc-qt-wallet_2.0.!NUMBER_GLOBAL!.beta.%1-win64-setup-%CPU_PACKAGE_NAME%.exe
)
